...
* SQLite isn't my go-to database.
  ...
  Initially, SQLite seemed to perform quite well (`dev/benchmark.clj`), bu some more testing indicates that it's probably not fit for this job (`dev/load_test.clj`).
